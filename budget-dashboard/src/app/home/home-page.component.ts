    ...
    <div class="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4">
      <div class="w-full max-w-sm rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-100">
        <div class="mb-8 text-center">
          ...
          <p class="mt-2 text-sm text-gray-500">Track your subscriptions and spending</p>
        </div>
        ...
        <button
          (click)="signIn()"
          [disabled]="loading()"
          class="flex w-full items-center justify-center gap-3 rounded-xl border border-gray-200
                 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm transition
